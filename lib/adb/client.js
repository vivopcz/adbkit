...
Client = (function() {
  ...
  Client.prototype.install = function(serial, options, callback) {
    var apk, args, temp;
    apk = options.apk;
    ...
    return this.push(serial, apk, temp).then((function(_this) {
      return function(transfer) {
        ...
        transfer.on('end', endListener = function() {
          return resolver.resolve(_this.installRemote(serial, temp, args));
        });
        return resolver.promise["finally"](function() {
  ...
  Client.prototype.installRemote = function(serial, apk, args, callback) {
    return this.transport(serial).then((function(_this) {
      return function(transport) {
        return new InstallCommand(transport).execute(apk, args).then(function() {
